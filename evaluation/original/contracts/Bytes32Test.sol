...
contract Bytes32Test {
    ...
    function zeroBytes32Test(address signer) public {
        IBytes32.Bytes32 memory bytesId = bytes32Contract.zeroBytes32();
    }

    function ffBytes32Test(address signer) public {
        IBytes32.Bytes32 memory bytesId = bytes32Contract.ffBytes32();
    }
    ...
    function toBytes32Test(address signer) public {
        ...
        IBytes32.Bytes32 memory bytesId = bytes32Contract.toBytes32(bytesData);
    }
    ...
    function fromAddressTest(address signer) public {
        IBytes32.Bytes32 memory bytesId = bytes32Contract.fromAddress(signer);
    }
}
