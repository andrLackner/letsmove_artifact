...
contract I64Test {
    II64 public immutable i64Original;

    constructor(address _nav) {
        i64Original = II64(_nav);
    }

    function zeroTest(address signer) public {
        II64.I64 memory i64id = i64Original.zero();
    }

    function fromU64Test(address signer) public {
        II64.I64 memory i64id = i64Original.fromU64(47);
    }

    function fromTest(address signer) public {
        II64.I64 memory i64id = i64Original.from(47);
    }

    function fromNegTest(address signer) public {
        II64.I64 memory i64id = i64Original.fromNeg(47);
    }

    function wrappingAddTest(address signer) public {
        II64.I64 memory i64id1 = i64Original.fromU64(44);
        II64.I64 memory i64id2 = i64Original.fromU64(44);
        II64.I64 memory i64id = i64Original.wrappingAdd(i64id1, i64id2);
    }

    function addTest(address signer) public {
        II64.I64 memory i64id1 = i64Original.fromU64(44);
        II64.I64 memory i64id2 = i64Original.fromU64(44);
        II64.I64 memory i64id = i64Original.add(i64id1, i64id2);
    }

    function wrappingSubTest(address signer) public {
        II64.I64 memory i64id1 = i64Original.fromU64(44);
        II64.I64 memory i64id2 = i64Original.fromU64(44);
        II64.I64 memory i64id = i64Original.wrappingSub(i64id1, i64id2);
    }

    function subTest(address signer) public {
        II64.I64 memory i64id1 = i64Original.fromU64(44);
        II64.I64 memory i64id2 = i64Original.fromU64(44);
        II64.I64 memory i64id = i64Original.sub(i64id1, i64id2);
    }

    function mulTest(address signer) public {
        II64.I64 memory i64id1 = i64Original.fromU64(44);
        II64.I64 memory i64id2 = i64Original.fromU64(44);
        II64.I64 memory i64id = i64Original.mul(i64id1, i64id2);
    }

    function divTest(address signer) public {
        II64.I64 memory i64id1 = i64Original.fromU64(44);
        II64.I64 memory i64id2 = i64Original.fromU64(44);
        II64.I64 memory i64id = i64Original.div(i64id1, i64id2);
    }

    function absTest(address signer) public {
        II64.I64 memory i64id1 = i64Original.fromU64(44);
        II64.I64 memory i64id = i64Original.abs(i64id1);
    }
    ...
    function minTest(address signer) public {
        II64.I64 memory i64id1 = i64Original.fromU64(44);
        II64.I64 memory i64id2 = i64Original.fromU64(44);
        II64.I64 memory i64id = i64Original.min(i64id1, i64id2);
    }

    function maxTest(address signer) public {
        II64.I64 memory i64id1 = i64Original.fromU64(44);
        II64.I64 memory i64id2 = i64Original.fromU64(44);
        II64.I64 memory i64id = i64Original.max(i64id1, i64id2);
    }

    function powTest(address signer) public {
        II64.I64 memory i64id1 = i64Original.fromU64(44);
        II64.I64 memory i64id = i64Original.pow(i64id1, 2);
    }
}
